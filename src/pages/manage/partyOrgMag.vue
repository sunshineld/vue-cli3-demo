    ...
    <div class="log" id="partyOrgMag">
        ...
        <el-col :span="24">
            <el-tree :data="list" style="padding-right: 20px;" :highlight-current="true" :render-content='renderContent'
                     :expand-on-click-node='false' :props="defaultProps" node-key="id" default-expanded-keys=[2]  ref="tree">
            </el-tree>
        </el-col>
                    ...
                    <el-col :span='12'>
					    ...
					    <el-col :span='12'>
	                        <el-form-item label="上级党组织" prop="parentId">
	                            <el-select v-model="newQuerys.parentId" clearable filterable  placeholder="请选择上级党组织">
                                    <v-yvoption tableName="party_org" label="name" value='id'></v-yvoption>
                                </el-select>
	                        </el-form-item>
	                    </el-col>
					    <el-col :span='12'>
	                        <el-form-item label="所属地区" prop="areaId">
                                <el-select v-model="newQuerys.areaId" clearable filterable  placeholder="请选择地区">
...
<script>
    import {
        // delPartyOrgs as del,
        getPartyOrgsTree as get,
        // postPartyOrgs as post,
        // putPartyOrgs as put,
    } from '../../api/api';
    ...
    export default {
        ...
        data() {
            return {
                ...
                addQuery:{
                    ...
                    establishRatifyImgs:'',
                    commissionerCountRatifyImgs:''
                },
                rules:{
                	name:[{required: true,message: '请输入党支部名称',trigger: 'blur'},{max: 255, message: '长度错误!', trigger: 'blur' }],
                	level:[{required: true,message: '请输入党支部级别',trigger: 'blur'}],
        ...
        methods:{
            ...
            changeIsAssign() {
                console.log(this.newQuerys.isAssignFirstSecretary)
                if(this.newQuerys.isAssignFirstSecretary == 0){
                    this.newQuerys.assignFirstSecretaryName = ''
                }
            },
...
<style>
    #partyOrgMag .el-tree-node__content{
        position: relative;
        padding: 10px;
    }

    #partyOrgMag .pull-right {
        position: absolute;
        right: 0;
    }
    #partyOrgMag .el-tree{
